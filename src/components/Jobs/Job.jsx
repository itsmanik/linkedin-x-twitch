...
const members = [
    {
        ...
        job_description:
            "Google is expanding its team and actively seeking talented professionals across various departments. If you're passionate about innovation and ready to take on new challenges, apply now to join one of the world's leading tech companies.",
        job_type: "Full-time",
        location: "Remotely",
    ...
    },
    {
        ...
        job_description:
            "GitHub is excited to announce that we're expanding our team and looking for passionate developers and tech enthusiasts. Join us to help shape the future of software development and collaborate with some of the best minds in the industry.",
        job_type: "Part-time",
    ...
    },
    {
        ...
        job_description:
            "Figma is growing and we're on the lookout for creative and innovative professionals to join our team. If you're passionate about design and want to help shape the future of collaborative design tools, we'd love to hear from you.",
        job_type: "Full-time",
        location: "Mauritania",
        path: "javascript:void(0)",
    },
                                ...
                                <a href={item.path} className="space-y-3">
                                    <div className="flex items-center gap-x-3">
                                        ...
                                        <div>
                                            ...
                                            <h3 className="text-base text-lightWhite font-semibold mt-1">
                                                {item.job_title}
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-sm text-gray-600 flex items-center gap-6">
                                        ...
                                        <span className="flex items-center gap-2">
                                            <svg
                                                className="w-5 h-5 text-lightWhite"
                                                viewBox="0 0 20 20"
                                                fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                            >
