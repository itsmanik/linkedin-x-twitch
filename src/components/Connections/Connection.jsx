...
const Connection = (props) => {
    return (
        ...
        >
            <div className="flex border bg-darkBlack hover:translate-x-2 transition-all hover:-translate-y-2 border-darkGray cursor-pointer flex-col justify-center max-w-72 p-6 shadow-md sm:px-6 dark:bg-gray-50 dark:text-gray-800">
                <img
                    src={props.src}
                ...
                <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                    <div className="my-2 space-y-1">
                        ...
                        <p className="px-5 text-xs sm:text-sm dark:text-gray-600">
                            {props.profession}
                        </p>
                    </div>
